...
public class Assist {
	...
	public TimeSeries readData(String filename, String splitOp) {
		...
		// vals[1] is observation,vals[2] is truth
	...
	public TimeSeries2 readData2(String filename, String splitOp) {
		...
		// vals[1] is x_value，vals[2] is y_value, vals[3] is x_truth，vals[4] is y_truth
		while ((line = br.readLine()) != null) {
			String[] vals = line.split(splitOp);
			timestamp = Long.parseLong(vals[0]);
	...
	public TimeSeriesN readDataN(String filename, String splitOp, int n) {
		...
		try {
			...
			// vals[1]-vals[n] is value，vals[n+1]-vals[2n] is truth
			while ((line = br.readLine()) != null) {
				String[] vals = line.split(splitOp);
	...
	// add noise , The maximum and minimum values of all data, separate two dimensions
	...
	// add noise , The maximum and minimum values of all data, Combining two dimensions
	...
	// add noise , The maximum and minimum values of all data, Dimension separation
	...
	// add noise , The maximum and minimum values of all data, Dimension together
